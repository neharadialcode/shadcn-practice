...
const CategoryProduct = ({ handleChange, selectedValues }) => {
  return (
    <>
              ...
              <div className="p-0">
                ...
                <CardFooter className="flex flex-wrap gap-1 lg:gap-2">
                  <button
                    onClick={() =>
                      handleChange({
                        target: { type: "button", id: value.badgeFirstName },
                      })
                    }
                  >
                    {value.badgeFirst}
                  ...
                  <button
                    onClick={() =>
                      handleChange({
                        target: { type: "button", id: value.badgeSecondName },
                      })
                    }
                    className={
                  ...
                  <button
                    onClick={() =>
                      handleChange({
                        target: { type: "button", id: value.badgeThirdName },
                      })
                    }
                  >
                    {value.badgeThird}
                  ...
                  <button
                    onClick={() =>
                      handleChange({
                        target: { type: "button", id: value.badgeFourName },
                      })
                    }
                  >
                    {value.badgeFourth}
