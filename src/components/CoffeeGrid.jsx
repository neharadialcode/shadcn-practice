...
const CoffeeGrid = () => {
  return (
    <div className="grid sm:grid-cols-3 grid-cols-2 max-w-[1920px] mx-auto">
      <Link href="#" className="relative col-span-2 overflow-hidden group">
        <Image
          className="w-full xl:h-[240px] h-full object-cover min-h-[100px] group-hover:scale-[1.1] transition-all duration-500"
      ...
      <Link href="#" className="relative row-span-2 overflow-hidden group">
        <Image
          className="w-full xl:h-[480px] h-full object-cover group-hover:scale-[1.1] transition-all duration-500"
