    ...
    return (
        <>
            <Select className="p-0 border-none focus:border-none ">
                <SelectTrigger className={`p-0 bg-transparent group min-w-[97px] text-white hover:text-opacity-80 duration-300 border-none outline-none focus:outline-none ${props.className}`}>
